  ...
  return (
    <main className="min-h-screen bg-deep-navy-black text-institutional-white relative overflow-hidden flex flex-col items-center justify-center p-6">
      ...
      <div className="relative z-10 max-w-7xl w-full text-center">
        ...
        <div className="w-44 h-44 mx-auto mb-12 text-electric-cyan drop-shadow-[0_0_25px_rgba(0,210,255,0.4)] transition-all duration-1000 hover:scale-110">
        ...
        <h1 className="font-institutional text-[5rem] md:text-[12rem] font-black uppercase tracking-tighter leading-[0.85] mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <a href="https://inspiron.tech" target="_blank" className="bg-white/5 border border-white/10 p-8 rounded-sm hover:border-electric-cyan hover:bg-white/[0.08] transition-all group relative overflow-hidden">
